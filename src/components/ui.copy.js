...
export const ui = {
  ...
  faq: {
    ...
    es: [
      ...
      },
      {
        ...
        answer: "Absolutamente. Heaven Flow está diseñado desde cero para el curioso, no para el experto. Nuestras sesiones de yoga son completamente accesibles — no se requiere experiencia previa, solo disposición. Nuestro sommelier tiene el mismo don para hacer que el mundo del vino se sienta acogedor en lugar de intimidante. Muchos de nuestros huéspedes llegan sabiendo muy poco y se van sintiéndose profundamente conectados con ambas prácticas. El único requisito para estar aquí es el deseo de estar presente.",
      },
      {
  ...
  footer: {
    en: {
      ...
      brand:       "Heaven Flow is a curated full-day sanctuary experience in Málaga, combining Sommelier-led wine education, restorative yoga, and locally sourced coastal cuisine. Intimate by design. Transformative by nature.",
      socialProof: "Rated 5.0 · Trusted by guests from 24 countries",
      copyright:   "© 2026 Heaven Flow. All rights reserved.",
      links: {
    ...
    es: {
      ...
      brand:       "Heaven Flow es una experiencia santuario de día completo en Málaga, que combina educación vinícola dirigida por sommelier, yoga restaurador y cocina costera de producto local. Íntimo por diseño. Transformador por naturaleza.",
      socialProof: "Valoración 5,0 · Huéspedes de confianza de 24 países",
      copyright:   "© 2026 Heaven Flow. Todos los derechos reservados.",
      links: {
  ...
  form: {
    en: {
      ...
      confirmation: {
        ...
        body:    "Thank you for reaching out. Someone from the Heaven Flow team will be in touch within 24 hours to confirm your space and answer any questions.",
      },
    },
    es: {
      ...
      confirmation: {
        ...
        body:    "Gracias por contactarnos. Alguien del equipo de Heaven Flow se pondrá en contacto contigo en 24 horas para confirmar tu plaza y responder cualquier pregunta.",
      },
    },
  },
