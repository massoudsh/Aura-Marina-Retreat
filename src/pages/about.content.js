...
export const aboutContent = {
  ...
  team: {
    en: {
      label: "The People",
      intro: "Wine & Flow is a collaboration between three practitioners who have each spent years becoming genuinely expert in their field — and who believe those fields belong together.",
      members: [
        {
          role: "Sommelier",
    ...
    es: {
      label: "Las Personas",
      intro: "Wine & Flow es una colaboración entre tres profesionales que han pasado años convirtiéndose en verdaderos expertos en su campo — y que creen que esos campos pertenecen juntos.",
      members: [
        {
          role: "Sommelier",
