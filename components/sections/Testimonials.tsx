...
const TESTIMONIALS = {
  en: [
    ...
    {
      quote: "Wine & Flow is the most intentional luxury I have experienced in years. Every detail — from the handwritten welcome card to the final tisane — felt considered. Not performative. Real.",
  ...
  es: [
    ...
    {
      quote: "Wine & Flow es el lujo más intencional que he experimentado en años. Cada detalle — desde la tarjeta de bienvenida escrita a mano hasta la tisana final — parecía pensado. No performativo. Real.",
